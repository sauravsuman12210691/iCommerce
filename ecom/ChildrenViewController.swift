...
class ChildrenViewController:  UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {

    let items = [
        ("Fastrack", "₹3349", UIImage(named: "childwatch")),
        ("Sneakers", "₹999", UIImage(named: "childshoes")),
        ("Backpack", "₹2099", UIImage(named: "Bagpack")),
        ("Cap", "₹400", UIImage(named: "Cap")),
        ("Hoodie", "₹2099", UIImage(named: "Hoodie"))
    ]
